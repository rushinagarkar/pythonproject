...
def scrapDetails():
    if request.method == "POST":
        ...
        try:
            ...
            commentboxes = prod_html.find_all('div', {'class': "_2wzgFH"})  # finding the HTML section containing the
            ...
            for commentBox in commentboxes:
                try:
                    name = commentBox.div.nextSibling.nextSibling.nextSibling.div.find_all("p", {"class" : "_2sc7ZR _2V5EHH"})[0].text
                except:
                    name = 'No Name'
                try:
